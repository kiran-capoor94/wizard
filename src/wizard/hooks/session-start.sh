...
# Serialize concurrent SessionStart hooks (e.g. two terminals opening at
# once) around the settings.json read-modify-write below — without this,
# whichever process writes last silently discards the other's
# companyAnnouncements/spinnerVerbs/spinnerTipsOverride/statusLine changes.
